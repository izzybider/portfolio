/* ============================================================
   TRUSTLAYER DECISION ENGINE — ported verbatim from
   ~/Documents/trustlayer `lib/policy/engine.ts`.

   Only the import path for the shared types changed (that repo infers
   them from zod schemas; the portfolio declares them directly in
   ./types). The eleven rules, their order, their wording, the factor
   builder and applyToolResults are unmodified, so the demo and the
   benchmark in the case study cannot drift apart.
   ============================================================ */
